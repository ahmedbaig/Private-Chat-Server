...
exports.getRooms = async(req, res) => {
    let queryStr = {}
    if (req.query.stream != null && req.query.stream != undefined && req.query.stream != "") {
        queryStr['isStream'] = req.query.stream
    }

    if (req.query.room != null && req.query.room != undefined && req.query.room != "") {
        queryStr['roomName'] = new RegExp(["^", req.query.room, "$"].join(""), "i");
    }
    RoomModel.find(queryStr, (err, rooms) => {
